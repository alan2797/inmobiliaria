...
const FichaProduccion = ({ history }) => {
  const [fichaProduccion, setData] = useState([]);
  ...
  return (
    <Box p={3}>
      ...
      <Box mt={2}>
        <EnhancedTable
          headTable={headCells}
          rowIdName={"idficha_produccion"}
          dataTable={fichaProduccion}
          titleTable={"Lista de Producción"}
